...
def start(target, counter, delay, ch, cc):
    ...
    while success < (int(bombs)):
        ...
        print("              This Bomber Was Created By SILENCER 🤫 !!                ")
        print("==================================================================")
        try:
...
def update():
    ...
    for fl in stuff_to_update:
        dat = urllib.request.urlopen(
            "https://raw.githubusercontent.com/hk4crprasad/Evil-sms/master/" + fl).read()
        file = open(fl, 'wb')
        file.write(dat)
        file.close()
    print('\n\t\tUpdated Successfull !!!!')
...
ver = urllib.request.urlopen(
    "https://raw.githubusercontent.com/hk4crprasad/Evil-sms/master/.version").read().decode('utf-8')
verl = ''
try:
...
try:
    noti = urllib.request.urlopen(
        "https://raw.githubusercontent.com/hk4crprasad/Evil-sms/master/.notify").read().decode('utf-8')
...
maxlim = 0
if cc == "91":
    maxlim = 50000000000000000000000000000000
else:
    maxlim = 10000000000000000000000000000000
if nm > maxlim:
